...
export default function SectionTitle({
  ...
  return (
    <section className={`transition-colors duration-300 ${bgClass}`}>
      <div
        className={`
      ...
      >
        ...
        {/* TITLE */}
        <h1 className="relative inline-block text-3xl md:text-4xl font-semibold tracking-tight text-slate-900 dark:text-white">
          {title}
          ...
          <span
            className="
              ...
              hover:scale-x-100 transition-transform duration-500
        ...
        {/* DIVIDER */}
        <div className="mt-6 h-[1px] w-24 rounded-full bg-gradient-to-r from-blue-500/50 to-indigo-500/50 dark:from-cyan-400/60 dark:to-blue-500/60" />
      </div>
    </section>
  );
}
